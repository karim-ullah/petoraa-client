...
const Hero = () => {
  return (
    <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center px-3 py-16">
      {/* Left Side */}
      <div>
        ...
        <p className="mt-4 text-foreground text-lg">
          Find loving dogs and cats waiting for a home. Give them a second
          chance and bring happiness to your life.
        </p>

        {/* Buttons */}
        <div className="mt-6 flex gap-4">
          <button className="px-6 py-3 bg-accent text-white rounded-lg cursor-pointer">
            <Link href={"/all-pets"}>Adopt Now</Link>
          </button>
